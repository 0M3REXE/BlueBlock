...
export default function WorkflowSection() {
  return (
    <section className="mx-auto max-w-5xl py-16 sm:py-20 md:py-24" id="workflow">
      <div className="mb-8 flex flex-col gap-2 sm:mb-12 sm:gap-3">
        <h2 className="font-heading text-xl font-semibold tracking-tight text-white sm:text-2xl md:text-3xl">Workflow</h2>
      ...
      <ol className="grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
        {STEPS.map(s => (
          <li key={s.title} className="group relative flex flex-col gap-2.5 rounded-lg border border-white/10 bg-white/[0.03] p-4 sm:gap-3 sm:p-5">
